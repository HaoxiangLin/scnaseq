...
public class PhenotypeDataCollection extends LikelihoodDataCollection{
     // IlluminaProbB distB;
   //   IlluminaProbR distR;
...
@Override
    ...
    public  PhenotypeDataCollection (File f, short index, int no_copies, int[][] mid,  File bf,
    		Collection<String> snpidrest) throws Exception{
        super(f, index, no_copies, mid, bf,snpidrest);
        
    }
 
    public PhenotypeDataCollection(PhenotypeDataCollection collection) {
      super(collection);
      this.dc = collection.dc;
     
    }
    public PhenotypeDataCollection(DataCollection obj) {
        super(obj);
   //     this.make();
       // this.stSp = obj.stSp;
...
public final void makeDistributions(int index) {
    ...
    public DataC clone(){
        return new PhenotypeDataCollection(this);
    }
