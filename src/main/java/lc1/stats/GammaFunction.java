...
public class GammaFunction
{
	 ...
	 */
	public static double incompleteGammaQLog(double a, double x)
	{
		return 1.0 - incompleteGammaLog(x, a, lnGamma(a));
	}
	 ...
	 * @return function value
	 */
	public static double incompleteGammaPLog(double a, double x)
	{
		return incompleteGammaLog(x, a, lnGamma(a));
	}
	 ...
	 * @return function value
	 */
	public static double incompleteGammaPLog(double a, double x, double lnGammaA)
	{
		return incompleteGammaLog(x, a, lnGammaA);
	}
	 ...
	 */
	private static double incompleteGammaLog(double x, double alpha, double ln_gamma_alpha)
	{
		...
		if (x > 1 && x >= p)
		{
	 		...
	 		do
			{
	 		...
	 		return Math.log10(factor)+Math.log10(gin);
			//gin = 1-factor*gin;
		}
		else
		{
